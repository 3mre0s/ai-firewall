...
- Vault evictions result in unmasked labels in responses (monitor `vault_evictions_total` metric)
...
[Unreleased]: https://github.com/localai/firewall/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/localai/firewall/releases/tag/v0.1.0
[0.0.0]: https://github.com/localai/firewall/releases/tag/v0.0.0
