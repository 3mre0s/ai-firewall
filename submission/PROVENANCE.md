...
- Current-CLI Safe Session hardening that disables Apps and request compression for the protected child, locks provider routing/transport overrides, and makes any trapped non-loopback egress a verification failure without hostname allowlists.
